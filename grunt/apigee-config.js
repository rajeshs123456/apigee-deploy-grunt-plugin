exports.profiles = function(grunt){
	return	{
			...
			'test' : {
					...
					org : 'shivam069-eval', // replace with organization
					env : 'test',     // replace with environment
					url_mgmt : 'https://api.enterprise.apigee.com',  // for cloud environments, leave as is
					username : 'shivam069@yahoo.com' //|| process.env.ae_username, // pass credentials as arguments as grunt task --username=$ae_username --password=$ae_password
					password : '@Test1234', //|| process.env.ae_password, // use ae_username and ae_password are defined as environment variables and no arguments are passed
				...
				'prod' : {
					apiproxy : 'forecastweather-grunt-plugin-api',
					org : 'shivamadishet-trial', // replace with organization
